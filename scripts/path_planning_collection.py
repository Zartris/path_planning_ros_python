...
if __name__ == '__main__':
    ...
    scale = 1
    s_start = (int(300 * scale), int(300 * scale))
    s_goal = (int(362 * scale), int(362 * scale))
    ...
    dijkstra(inflated_map, s_start, s_goal, False)
    a_star(inflated_map, s_start, s_goal, False)
